...
일반 공중 적은 기총만 발사합니다. 공중 생성의 30%는 엘리트이며 이 비율은 `src/enemies/formation.js`의 `ELITE_AIR_PROBABILITY`에서 관리합니다. 엘리트 미사일은 피해 14, 최고 속도 700m/s, 선회 0.65rad/s입니다. 기관포·대공포 피해는 4입니다. 보스 미사일은 피해 20, 최고 속도 850m/s, 선회 0.9rad/s를 유지합니다. 적 전체 미사일은 동시에 최대 2발, 엘리트 발사 후 5초·보스 발사 후 3.5초의 공통 대기 시간을 적용합니다. 지상·해상 사격 후보는 가까운 2곳으로 제한합니다. 공격 정책은 `src/enemies/attack-policy.js`, 무기 원본은 `weapons.xlsx`에서 관리합니다. 압박 시험의 조정 전 기준은 당시의 모든 공중 적 미사일 발사를 재현하며, 현재값은 엘리트 생성과 전용 미사일 역할을 반영합니다.
